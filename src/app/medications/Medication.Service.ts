...
export class MedicationService {
  ...
  private MedicationList: Medication[] = [
    ...
    new Medication(4, 'Metroprolol', '', false, 'One time in a day', '3.125 mg capsules per dose', 'Oral', '01/15/2017', '', false, 'Nebraska Medical Center Outpatient', '800-233-3435', '989200 Nebraska medical center', '', 'Omaha- 68192-9200', 'NE'),
