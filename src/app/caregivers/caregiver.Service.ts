...
export class caregiverService{
  ...
  caregiversList : caregiver[] = [
    new caregiver( 1, "Tom Windle", "","Tom.Windle@unmc.edu","(402) 987- 3241","Friend",false,true,true,true,true,false,true,false,true,false,true,false,true,false,true),
    new caregiver( 2, "Yves", "","yves@unomaha.edu","(402) 458- 7412","Son",false,true,true,true,true,false,true,false,true,false,true,false,true,false,true),
    new caregiver( 3, "Aditya", "","achouhan@unomaha.edu","(402) 913- 4882","Father",false,true,true,true,true,false,true,false,true,false,true,false,true,false,true),
    ];
